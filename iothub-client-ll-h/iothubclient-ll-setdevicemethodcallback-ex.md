...
> Deprecated: IoTHubClient_LL_SetDeviceMethodCallback_Ex is deprecated. Use [IoTHubDeviceClient_LL_SetDeviceMethodCallback()](../iothub-device-client-ll-h/iothubdeviceclient-ll-setdevicemethodcallback.md) instead.
