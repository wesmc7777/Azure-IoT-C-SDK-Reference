...
```C
IOTHUB_DEVICE_CLIENT_LL_HANDLE IoTHubDeviceClient_LL_CreateFromDeviceAuth(const char *iothub_uri MU_IFCOMMA6 const char *device_id MU_IFCOMMA4   MU_IFCOMMA2);
```
