...
ceClient_LL_Destroy function from within any callback.

## Return Value
IOTHUB_CLIENT_OK upon success or an error code upon failure.

_OK upon success or an error code upon failure.

ary/windows/desktop/aa384116(v=vs.85).aspx) API.
...
* **OPTION_TRUSTED_CERT** - Azure Server certificate used to validate TLS connection to iothub.
